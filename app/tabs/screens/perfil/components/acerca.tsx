...
import { signOut } from '@shared/context/authContext/auth-service.ts';
...
const Acerca = () => {
  ...
  const MostrarVersion = () => {
    Alert.alert('Versión', `La versión actual de la app es: 1.0.0`, [
      { text: 'OK' },
    ]);
  };
  ...
  return (
    <>
      ...
      <TouchableOpacity style={styles.fila} onPress={() => MostrarVersion()}>
